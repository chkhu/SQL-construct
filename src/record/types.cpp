...
void Type::Print(const Field &val) const {
    ASSERT(false, "Print not implemented.");
}

void TypeInt::Print(const Field &val) const {
    if (val.IsNull()) {
        std::cout << "NULL";
    } else {
        std::cout << val.value_.integer_;
    }
}

void TypeFloat::Print(const Field &val) const {
    if (val.IsNull()) {
        std::cout << "NULL";
    } else {
        std::cout << val.value_.float_;
    }
}

void TypeChar::Print(const Field &val) const {
    if (val.IsNull()) {
        std::cout << "NULL";
    } else {
        std::cout << val.value_.chars_;
    }
}
